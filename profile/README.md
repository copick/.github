...
| [py2rely](https://github.com/chanzuckerberg/py2rely) | | | Sub-tomogram averaging workflows for SLURM-based HPC | `pip install -e .` |
...
| [slabpick](https://github.com/apeck12/slabpick) | | | Particle picking from 2D projections of tomography data | `pip install slabpick` |
